...
<div style={theme === 'dark' ? 'background: black;' : 'background: white;'}>
  ...
  <div transition:fade>
    {#if theme === 'light'}
      <div class="w-screen h-screen bg-white text-black flex flex-col justify-center items-center">
        <h3 class="w-full text-center">Welcome 👋</h3>
      </div>
    {/if}
    {#if theme === 'dark'}
      <div class="w-screen h-screen bg-black text-white flex flex-col justify-center items-center">
        <h3 class="w-full text-center">Welcome 👋</h3>
      </div>
    {/if}
  </div>
{:else}
  <div transition:fade>
    <MaterialApp theme="{theme}">
      ...
      {/if}
      <div class="{mobile ? 'flex flex-row h-screen min-h-screen pt-16' : 'flex flex-row h-screen min-h-screen'}">
        <div
        ...
        >
          <div class="w-full h-full" style={mobile ? 'margin-top: 4rem;' : 'margin-top: 4rem; padding-right: 0.5rem;'}>
            <slot />
          </div>
        </div>
      </div>
